...
from raschet import data_make

resp = rq.post('https://test-api.polis.online/api/signup', json={
  "email": "tuespost@test.com",
  "password": "Qwerty123",
  "first_name": "Иван",
  "last_name": "Иванов",
...
req = rq.post('https://test-api.polis.online/api/policy')
